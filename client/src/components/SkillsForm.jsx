    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex gap-2">
                <input onChange={(e)=>{setNewSkill(e.target.value)}} value={newSkill} onKeyDown={handleKeyPress} type="text" placeholder="Enter a skill (e.g., JavaScript, Project Management)" className="flex-1 px-3 py-2 text-sm" />
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
                <p className="text-sm text-blue-800"><strong>Tip:</strong> Add 8-12 relevant skills. Include both technical skill (programming languages, tools) and soft skills (leadership, communication).</p>
            </div>
        </div>
    )
}
